                    ...
                    <div class="row" id="error-page">
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="box">
                                ...
                                <h4 class="text-muted">Error 401 - Authorization Error</h4>

                                <p class="text-center">To continue please use the <strong>Login with Admin</strong> or <strong>don't enter the url link</strong> above.</p>
